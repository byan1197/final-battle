...
public class Game extends Canvas implements Runnable{
 ...
 public void init(){
  ...
  tex = new Texture();
   try {
   menuIMG = loaderMenu.loadImage ("/BG.jpg");
  } catch (IOException e) {
   e.printStackTrace();
  }
  try {
   gameBG = loaderGBG.loadImage ("/GAME_BG.JPG");
  } catch (IOException e) {
   e.printStackTrace();
  }
   try {
    charSelIMG = loaderChar.loadImage ("/CHAR_BG.jpg");
   } catch (IOException e) {
    e.printStackTrace();
   }
 ...
 public void keyPressed(KeyEvent e){
  ...
  else if (key == KeyEvent.VK_J && !p.inAction){
   p.punch = true;
   p.inAction = true;
  ...
  else if (key == KeyEvent.VK_K && !p.inAction){
   p.kick = true;
   p.inAction = true;
...
//kick audio file
  ...
  else if (key == KeyEvent.VK_L && !p.inAction){
   p.special = true;
   p.inAction = true;
   if (ChoiceP1 == CHOICEP1.BONDP1){
	   c.addEntity(new Shuriken (p.getX(), p.getY(), this,c,  p.facing * 4));	   
   }
   else if (ChoiceP1 == CHOICEP1.SAADP1){
	   c.addEntity(new Saadouken (p.getX(), p.getY(), this, c, p.facing * 4));	
   }
 ...
 //  
  ...
  else if (key == KeyEvent.VK_S && key == KeyEvent.VK_D&& !p.inAction){
   p.setX(p.getX() + 140);
   p.strafe = true;
   p.inAction = true;
  }
  else if(key == KeyEvent.VK_S && key == KeyEvent.VK_A&& !p.inAction) {
   p.setX(p.getX() - 140);
   p.strafe = true;
   p.inAction = true;
  }
  ...
  else if (key == KeyEvent.VK_DOWN && key == KeyEvent.VK_RIGHT && !p2.inActionP2) {
   p2.strafeP2 = true;
   p2.inActionP2 = true;
   
  }
  else if (key == KeyEvent.VK_NUMPAD1 && !p2.inActionP2){
   p2.punchP2 = true;
   p2.inActionP2 = true;
  ...
  else if (key == KeyEvent.VK_NUMPAD2 && !p2.inActionP2){
   p2.kickP2 = true;
   p2.inActionP2 = true;
         try{
    AudioInputStream audioInputStream =
  ...
  else if (key == KeyEvent.VK_NUMPAD3 && !p2.inActionP2){
   p2.specialP2 = true;
   p2.inActionP2 = true;
   if (ChoiceP2 == CHOICEP2.BONDP2){
	   c.addEntity(new Shuriken (p2.getX(), p2.getY(), this, c, p2.facingp2 * 5));	   
   }
   else if (ChoiceP2 == CHOICEP2.SAADP2){
	   c.addEntity(new Saadouken(p2.getX(), p2.getY(), this, c, p2.facingp2 * 5));	   
   }
